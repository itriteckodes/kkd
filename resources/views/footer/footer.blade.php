				...
				<div class="row">
					...
					<div class="col-lg-3 col-md-6 col-12">
						...
						<div class="single-footer social">
							...
							<div class="contact">
								<ul>
									<li>NO. 467 - Sargodha Old Satellite town.</li>
									<li>A Block Sargodha</li>
									<li>MuhammadSalmanKhan277@gmail.com</li>
				...
				<div class="inner">
					<div class="row">
						<div class="col-lg-6 col-12">
							<div class="left">
								<p>Copyright © 2021 <a href="{{url('index')}}" target="_blank">Index</a>  -  All Rights Reserved.</p>
								</div>
						</div>
						<div class="col-lg-6 col-12">
							<div class="right">
