								...
								<div class="row">
									<div class="col-lg-6 col-md-6 col-12">
										<div class="form-group">
											...
											<input type="text" name="fname" placeholder="" value="{{ Auth::guard('user')->user()->fname }}" required="required">
										</div>
									</div>
									<div class="col-lg-6 col-md-6 col-12">
										<div class="form-group">
											<label>Last Name<span>*</span></label>
											<input type="text" name="lname" placeholder="" value="{{ Auth::guard('user')->user()->lname }}" required="required">
										</div>
									</div>
									<div class="col-lg-6 col-md-6 col-12">
										<div class="form-group">
											<label>Email Address<span>*</span></label>
											<input type="email" name="email" placeholder="" value="{{ Auth::guard('user')->user()->email }}" required="required">
										</div>
									</div>
									<div class="col-lg-6 col-md-6 col-12">
										<div class="form-group">
									...
									<div class="col-lg-6 col-md-6 col-12">
										<div class="form-group">
											...
											<select name="state" id="state-province">
												<option value="divition" selected="selected">Sargodha</option>
									...
									<div class="col-lg-6 col-md-6 col-12">
										<div class="form-group">
											...
											<input type="text" name="postal" placeholder="" required="required">
										</div>
									</div>
									<!--div class="col-lg-6 col-md-6 col-12">
										<div class="form-group">
					...
					<div class="col-lg-4 col-12">
						<div class="order-details">
							...
							<div class="single-widget">
								...
								<div class="content">
									<ul>
										<li>Sub Total<span>{{Session::get('cart')['amount']}}</span></li>
										<li>(+) Shipping<span>100.00</span></li>
										<li class="last">Total<span>{{Session::get('cart')['amount']+100}}</span></li>
									</ul>
								</div>
							</div>
							<!--/ End Order Widget -->
